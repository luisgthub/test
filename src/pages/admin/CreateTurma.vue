          ...
          <div class="px-4 py-5 bg-white sm:p-6">
            <div class="grid grid-cols-6 gap-6">
              <div class="col-span-6 sm:col-span-3">
                <label for="first-name" class="block text-sm font-medium text-gray-700">Nome da Turma:</label>
              ...
              <div class="col-span-6 sm:col-span-3">
                <label for="last-name" class="block text-sm font-medium text-gray-700">Descrição da Turma</label>
    ...
    setup() {
      ...
      onMounted(async()=> {
        ...
        const submit= async () => {
         ...
         // console.log(submit); 
            await axios.post('/teams/createteam',data);
